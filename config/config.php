...
class CMSNT
{
    ...
    {
        if (!$this->ketnoi) {
            $this->ketnoi = mysqli_connect('localhost', 'root', '', 'muareclo_shopclone') or die('Vui lòng kết nối đến DATABASE');
...
function CheckLogin()
{
    global $my_username;
    if ($my_username != True) {
        return die('<script type="text/javascript">setTimeout(function(){ location.href = "' . "../../public/client/Login.php" . '" }, 0);</script>');
    }
}
function CheckAdmin()
{
