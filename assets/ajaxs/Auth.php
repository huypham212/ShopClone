...
if ($_POST['type'] == 'Login') {
    ...
    msg_success('Đăng nhập thành công ', "../../public/client/Dashbroad.php", 1000);
}
...
if ($_POST['type'] == 'Register') {
    ...
    if ($create) {
        session_destroy();
        $_SESSION['username'] = $username;
        msg_success(lang(20), "../../public/client/Dashbroad.php", 1000);
    } else {
        msg_error2(lang(21));
    }
}
...
if ($_POST['type'] == 'ForgotPassword') {
    ...
    msg_success(lang(27), "../../public/client/ChangePassword.php", 4000);
}
...
if ($_POST['type'] == 'ChangeProfile') {
    if (empty($_SESSION['username'])) {
        msg_error("Vui lòng đăng nhập ", '', 2000);
    }
