...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="alert alert-dark">
            ...
            <ul>
                <li>9/10/2021: Fix lỗi mốc khuyến mãi.</li>
                <li>7/10/2021: Fix lỗi thực nhận nạp thẻ.</li>
                <li>6/10/2021: Ghi nhớ đăng nhập, chỉnh chiết khấu nạp thẻ, fix mốt số hiển thị.</li>
                <li>3/10/2021: Capchat khi đăng ký chống SPAM.</li>
                <li>2/10/2021: Thêm chức năng ẩn category API, Dark Mode.</li>
                <li>30/9/2021: Sắp xếp hiển thị sản phẩm API, thêm chức năng Promotion, tăng tốc độ load trang thành viên.</li>
                <li>25/9/2021: Bản vá linh tinh cho website.</li>
                <li>19/9/2021: Cập nhật nút Download Backup trong Admin.</li>
            </ul>
