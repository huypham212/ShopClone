                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <input class="form-control" type="text" id="magiaodich" placeholder="Vui lòng nhập mã đơn VD: W604E0EA769E25">
                                </div>
                            </div>
            ...
            <div class="col-sm-6">
                <div class="element-wrapper">
                    <div class="element-box text-center">
                        <img src="https://thesieure.com/storage/userfiles/images/logo_thesieurecom.png" height="80px;" />
                        <br><br>
                                ...
                                <tbody>
                                    <?php foreach ($CMSNT->get_list("SELECT * FROM `thesieure` WHERE `username` = '" . $getUser['username'] . "' ") as $momo) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a class="badge badge-danger" href=""><?= $momo['magiaodich']; ?></a></td>
