...
<body class="auth-wrapper">
    <div class="all-wrapper menu-side with-pattern">
        <div class="auth-box-w">
            <div class="logo-w">
                <a href="">
                    <img alt="" width="100%" src="<?= $CMSNT->site('logo'); ?>">
                </a>
            </div>
            <h4 class="auth-header"><?= lang(4); ?></h4>
            <form action="">
                <div id="thongbao"></div>
                <div class="form-group"><label for=""><?= lang(5); ?></label><input class="form-control" id="username" placeholder="<?= lang(7); ?>">
                    <div class="pre-icon os-icon os-icon-user-male-circle"></div>
                </div>
                <div class="form-group"><label for=""><?= lang(6); ?></label><input class="form-control" id="password" placeholder="<?= lang(8); ?>" type="password">
                    <div class="pre-icon os-icon os-icon-fingerprint"></div>
                </div>
                <div class="form-group">
                    <label for=""><a href="../../public/client/ForgotPassword.php"><?= lang(122); ?></a></label>
                </div>
                <div class="buttons-w">
                    <button class="btn btn-primary btn-block" id="Login" type="button"><?= lang(1); ?></button>
                    <a class="btn btn-danger btn-block" href="../../public/client/Register.php" type="button"><?= lang(2); ?></a>
                </div>
            </form>
        </div>
                                    ...
                                    ?>
                                        <tr>
                                            <td><img src="<?= BASE_URL($category['img']); ?>" width="30px" title="<?= $category['title']; ?>">
                                                <b data-content="<?= $row['mota']; ?>" data-toggle="popover" title="<?= $row['dichvu']; ?>"><?= $row['dichvu']; ?></b>
                                            </td>
...
<?php if (!isset($_SESSION['thongbaonoi'])) {
    $_SESSION['thongbaonoi'] = True; ?>
