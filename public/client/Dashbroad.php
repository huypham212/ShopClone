    ...
    <div class="content-box">
        <?php if (empty($getUser['email'])) { ?>
            <div class="alert alert-warning">
                ...
                Vui lòng <a href="<?= BASE_URL('public/client/Profile.php'); ?>">cập nhật</a> địa chỉ Email để bảo mật tài khoản.
            </div>
        <?php } ?>
        <div class="row">
            <div class="col-sm-12">
                <div class="element-wrapper compact pt-4">
                    <div class="element-actions"><a class="btn btn-primary btn-sm" href="<?= BASE_URL('public/client/History.php'); ?>"><i class="os-icon os-icon-rotate-cw"></i><span><?= lang(36); ?></span></a></div>
                            ...
                            <div class="col-lg-12 col-xxl-12">
                                <div class="element-balances">
                                    <div class="balance">
                                        ...
                                        <div class="balance-link"><a class="btn btn-link btn-underlined" href="<?= BASE_URL('public/client/Profile.php'); ?>"><span><?= lang(34); ?></span><i class="os-icon os-icon-arrow-right4"></i></a></div>
                                    </div>
                                    <div class="balance">
                                    ...
                                    <div class="balance">
                                        ...
                                        <div class="balance-link"><a class="btn btn-link btn-underlined btn-gold" data-target=".bd-example-modal-lg" data-toggle="modal"><span><?= lang(33); ?></span><i class="os-icon os-icon-arrow-right4"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><?= lang(102); ?></h5><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">
                                    &times;</span></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <?php if ($CMSNT->site('api_card') != '') { ?>
                                    <div class="col-sm-12">
                                        <a class="mr-2 mb-2 btn btn-primary btn-lg btn-block" href="<?= BASE_URL('public/client/Recharge-Card.php'); ?>" type="button"> NẠP THẺ CÀO TỰ ĐỘNG</a>
                                    </div>
                                <?php } ?>
                                <?php if ($CMSNT->site('status_cron_momo') == 'ON') { ?>
                                    <div class="col-sm-12">
                                        <a class="mr-2 mb-2 btn btn-warning btn-lg btn-block" href="<?= BASE_URL('public/client/Recharge-Momo.php'); ?>" type="button"> NẠP QUA VÍ MOMO TỰ
                                            ĐỘNG</a>
                                    </div>
                                <?php } ?>
                                <?php if ($CMSNT->site('status_zalopay') == 'ON') { ?>
                                    <div class="col-sm-12">
                                        <a class="mr-2 mb-2 btn btn-danger btn-lg btn-block" href="<?= BASE_URL('public/client/Recharge-ZaloPay.php'); ?>" type="button"> NẠP QUA VÍ ZALO PAY TỰ
                                            ĐỘNG</a>
                                    </div>
                                <?php } ?>
                                <?php if ($CMSNT->site('tk_tsr') != '' && $CMSNT->site('mk_tsr') != '') { ?>
                                    <div class="col-sm-12">
                                        <a class="mr-2 mb-2 btn btn-danger btn-lg btn-block" href="<?= BASE_URL('public/client/Recharge-Thesieure.php'); ?>" type="button"> NẠP QUA
                                            THESIEURE.COM</a>
                                    </div>
                                <?php } ?>
                                <div class="col-sm-12">
                                    <a class="mr-2 mb-2 btn btn-success btn-lg btn-block" href="<?= BASE_URL('public/client/Recharge-Bank.php'); ?>" type="button"> NẠP QUA NGÂN HÀNG</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <?php if ($CMSNT->site('type_buy') == 'LIST') { ?>
                                <div class="table-responsive">
                                    ...
                                    `loai` = '" . $category['title'] . "'  ORDER BY `stt` ASC ") as $row) {
                                            ...
                                            ?>
                                                <tr>
                                                    <td><img src="<?= BASE_URL($category['img']); ?>" width="30px" title="<?= $category['title']; ?>">
                                                        <b> <?= $row['dichvu']; ?></b>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($conlai != 0) { ?>
                                                            <button class="btn btn-outline-success btn-buy" conlai="<?= $conlai; ?>" gia="<?= $row['gia']; ?>" data-id="<?= $row['id']; ?>" api-id="" mota="<?= $row['mota']; ?>"><?= lang(83); ?></button>
                                                        <?php } else { ?>
                                            ...
                                            <div class="element-box el-tablo">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12"><br>
                                                        <button class="btn btn-info btn-block btn-lg btn-buy" style="color: white;" conlai="<?= $conlai; ?>" gia="<?= $row['gia']; ?>" data-type="" data-id="<?= $row['id']; ?>" mota="<?= $row['mota']; ?>">MUA NGAY</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-padded">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td>
                                                                <b><img src="<?= $category['image']; ?>" width="30px" title="<?= $category['name']; ?>"> <?= $row['name']; ?></b>
                                                            </td>
                                                            <td class="text-center">
                                                                <?php if ($row['country']) { ?>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php if ($row['amount'] != 0) { ?>
                                                                    ...
                                                                    <button class="btn btn-outline-success btn-buy" conlai="<?= $row['amount']; ?>" gia="<?= $row['price']; ?>" data-id="<?= $row['id']; ?>" data-type="api" api-id="<?= $list_api['id']; ?>" mota="<?= $row['description']; ?>"><?= lang(83); ?></button>
                                                                <?php } else { ?>
                                                                    <button class="btn btn-danger" disabled><?= lang(84); ?></button>
                                                                <?php } ?>
                                                            </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" min="1" value="1" class="form-control" id="modal-soluong" style="font-size: 16px;font-weight: bold;text-align: right;">
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" value="" readonly class="form-control" id="modal-gia" style="font-size: 16px;font-weight: bold;text-align: right;">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" value="<?= $getUser['chietkhau']; ?>%" readonly class="form-control" style="font-size: 16px;font-weight: bold;text-align: right;">
                            <input type="hidden" value="" readonly class="form-control" id="modal-available-amount">
                            <input type="hidden" value="" readonly class="form-control" id="modal-type-id">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" value="" readonly class="form-control" id="modal-total" style="font-size: 16px;color: red;font-weight: bold;text-align: right;">
                        </div>
                    </div>
                    <div class="form-group">
